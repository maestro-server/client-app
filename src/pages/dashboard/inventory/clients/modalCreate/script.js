...
export default {
  ...
  methods: {
    ...
    createSave() {
      ...
      FetchEntity(this.entity)().create(this.finishJob, this.model);
    },

    editSave() {
      this.setupModel();

      FetchEntity(this.entity)().update(this.finishJob, this.model);
    },
