<template>
  ...
  <bs-select v-if="options.length > 0" form-type="horizontal" :options="options" v-model="value.name" label="Datacenter"></bs-select>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <form class="col-xs-12">
          <bs-input class="mt10" v-model="datacenter.name" label="Datacenter" placeholder="AWS, Google Cloud, Azure"></bs-input>
        </form>
  ...
  <modal :title="'Zones ' + datacenter.name" effect="fade" v-model="showModalZones" @closed="showModalZones = false" sub-modal small>
    <div class="row">
      <div class="col-xs-12">
        ...
        <a href="#" @click.prevent.stop="addZones" class="btn btn-primary btn-sm pull-left"><i class="fa fa-plus-circle"></i> Zone</a>
      </div>
    </div>
