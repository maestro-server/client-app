...
export default {
  ...
  computed: {
    tab_general() {
      return this.$refs.tab_general;
    },
    tab_pivot() {
      return this.$refs.tab_pivot;
    }
  },
  ...
  methods: {
    ...
    nameTitle() {
      if (_.isEmpty(this.model.name)) {
        this.model.name = `${_.get(this, "model.report", "-")} ${_.get(
          this,
          "model.component",
          "-"
    ...
    createSave() {
      ...
      FetchEntity(Reports)().create(this.finishJob, this.model);
    },

    editSave() {
      this.setupModel();

      FetchEntity(Reports)().update(this.finishJob, this.model);
    },
